        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4 d-flex justify-content-end" id="navbar"> 
            ...
            <li class="nav-item dropdown px-3 d-flex align-items-center">
                ...
                <i class="fa fa-bell cursor-pointer ">
                    <span class="badge badge-sm badge-circle bg-primary border border-white border-2">{{auth()->user()->unreadNotifications->count()}}</span>
                </i>
                </a>
            ...
            @endforeach
            <li class="mb-2">
                <a class="dropdown-item border-radius-md" href="{{route('notification')}}">
                all notification
                </a>
            </li>
                </ul>
