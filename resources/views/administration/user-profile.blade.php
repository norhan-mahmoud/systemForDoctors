    ...
    <div class="container-fluid">
        ...
        <div class="card card-body blur shadow-blur mx-4 mt-n6">
            ...
            <div class="card-body pt-4 p-3">
                <form action="{{route('update-user',['id'=>$userInformation->id])}}" method="POST" role="form text-left">
                    @csrf
                    @if($errors->any())
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.name')border border-danger rounded-3 @enderror">
                                    <input class="form-control" value="{{$userInformation->name }}" type="text" placeholder="Name" id="user-name" name="name">
                                        @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('email')border border-danger rounded-3 @enderror">
                                    <input class="form-control" value="{{ $userInformation->email }}" type="email" placeholder="@example.com" id="user-email" name="email">
                                        @error('email')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.username')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text" placeholder="username" id="number" name="username" value="{{$userInformation->username}}">
                                        @error('username')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="user.location" class="form-control-label">{{ __('password') }}</label>
                                <div class="@error('user.password') border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="password" placeholder="Location" id="name" name="password" value="">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="@error('user.role')border border-danger rounded-3 @enderror">
                                        <select class="form-control" id="role_id" name="role">
                                            @foreach ( $roles as $role)
                                                <option value="{{$role->id}}" @selected($role->id==$userInformation->role_id)>{{$role->name}}</option>
                                            @endforeach
                                ...
                                <div class="@error('user.department')border border-danger rounded-3 @enderror">
                                        <select class="form-control" id="role_id" name="department">
                                            @foreach ( $departments as $department)
                                                <option value="{{$department->id}}" @selected($department->id==$userInformation->department_id)>{{$department->name}}</option>
                                            @endforeach
