    ...
    <div class="container-fluid">
        ...
        <div class="card card-body blur shadow-blur mx-4 mt-n6">
            ...
            <div class="card-body pt-4 p-3">
                <form action="{{route('store-user')}}" method="POST" role="form text-left">
                    @csrf
                    @if($errors->any())
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.password') border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="password" placeholder="Location" id="name" name="password" value="{{ old('password')}} }}">
                                </div>
                            </div>
                        </div>
                    </div>
