    ...
    <div class="container-fluid">
        ...
        <div class="card card-body blur shadow-blur mx-4 mt-n6">
            ...
            <div class="card-body pt-4 p-3">
                <form action="{{route('store-department')}}" method="POST" role="form text-left">
                    @csrf
                    @if($errors->any())
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('department.name')border border-danger rounded-3 @enderror">
                                    <input class="form-control" value="{{old('name')}}" type="text" placeholder="Name" id="department-name" name="name">
                                        @error('name')
