            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        <div>
                            <h5 class="mb-0">IRR</h5>
                        </div>
                        <div class="ms-md-3 pe-md-3 d-flex align-items-center">
                            <form action="{{route('searchIrr')}}" method="post">
                                @csrf
                    ...
                    <div class="table-responsive p-0">
                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <span>
                                    <a href="{{route('cdi',['id'=>$irr->id])}}" type="button" class="btn bg-gradient-primary">cdi</a>
                                    </span>
                                    <span>
                                        <a href="{{route('notCompleted',['id'=>$irr->id])}}" type="button" class="btn bg-gradient-secondary">not completed</a>
                                    </span>
                                </td>
                            </tr> 
                            @endforeach
